...
description: Visual regression and image-understanding workflows for screenshot comparison, diff detection, and CI checks via Playwright or Chromatic. Use for visual testing, screenshot diff, UI regression checks, or when users ask to read and compare images (PNG/JPG/BMP/WebP/GIF/TIFF) and explain text/layout changes.
---
...
## Extended Scope: Real Image Understanding

Use this skill not only for pixel-level diffs but also for semantic image reading tasks:

- Multi-format image inputs: PNG, JPG/JPEG, BMP, WebP, GIF, TIFF
- Read and explain UI structure, visual hierarchy, and layout changes
- Extract visible text and key labels from screenshots
- Compare two or more images and describe meaningful differences
- Distinguish cosmetic noise from behavior-relevant UI regressions
